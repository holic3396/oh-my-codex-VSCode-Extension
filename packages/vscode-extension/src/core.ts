...
async function importCoreModule(modulePath: string): Promise<OmxCore> {
  ...
  if (
    typeof imported.readWorkspaceSnapshot !== 'function' ||
    typeof imported.launchDirectSession !== 'function' ||
    typeof imported.readTeamSnapshot !== 'function' ||
    typeof imported.readControlCenterSnapshot !== 'function' ||
    typeof imported.readLogExplorerSnapshot !== 'function' ||
    typeof imported.searchOmxLogs !== 'function'
  ) {
